...
@app.get("/recipes/search_recipes/{recipe_name}")
def search_recipe(recipe_name: str):
    """Retrieve multiple recipes by their name.

    Args:
        recipe_name (str): name of the recipe to retrieve.

    Raises:
        HTTPException: If the recipe with the specified name is not found.

    Returns:
        array: The requested recipes.
    """
    recipes = load_recipes()
    matching_recipes = []
